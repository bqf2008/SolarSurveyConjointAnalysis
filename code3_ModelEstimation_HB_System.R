...
choicedata[,c("o1_None", "o1_Att1c", "o1_Att2_1", "o1_Att3_1", "o1_Att3_2", 
              "o1_Att4c", "o1_Att5c", "o1_Att6c")]  <- 
          option1[,c("None", "Att1c", "Att2_1", "Att3_1", "Att3_2", 
                     "Att4c", "Att5c", "Att6c")]
choicedata[,c("o2_None", "o2_Att1c", "o2_Att2_1", "o2_Att3_1", "o2_Att3_2", 
              "o2_Att4c", "o2_Att5c", "o2_Att6c")]  <- 
          option2[,c("None", "Att1c", "Att2_1", "Att3_1", "Att3_2", 
             "Att4c", "Att5c", "Att6c")]
choicedata[,c("o3_None", "o3_Att1c", "o3_Att2_1", "o3_Att3_1", "o3_Att3_2", 
              "o3_Att4c", "o3_Att5c", "o3_Att6c")]  <- 
          option3[,c("None", "Att1c", "Att2_1", "Att3_1", "Att3_2", 
                     "Att4c", "Att5c", "Att6c")]
choicedata[,c("o4_None", "o4_Att1c", "o4_Att2_1", "o4_Att3_1", "o4_Att3_2", 
              "o4_Att4c", "o4_Att5c", "o4_Att6c")]  <- 
          option4[,c("None", "Att1c", "Att2_1", "Att3_1", "Att3_2", 
                     "Att4c", "Att5c", "Att6c")]
...
likelihood <- function(fc, b) {
  ...
  ce_Att5c <- b[, cc]; cc <- cc + 1
  
  ce_Att6c <- fc[1] # fixed savings for each individual
  # ce_Att6c <- b[, cc]
  
  # Discrete choice utility in WTP-space
  v1 <- ce_Att1c * o1_Att1c + ce_Att2_1 * o1_Att2_1 + ce_Att3_1 * o1_Att3_1 + ce_Att3_2 * o1_Att3_2 + ce_Att4c * o1_Att4c + ce_Att5c * o1_Att5c + ce_Att6c * o1_Att6c  
  v2 <- ce_Att1c * o2_Att1c + ce_Att2_1 * o2_Att2_1 + ce_Att3_1 * o2_Att3_1 + ce_Att3_2 * o2_Att3_2 + ce_Att4c * o2_Att4c + ce_Att5c * o2_Att5c + ce_Att6c * o2_Att6c  
  v3 <- ce_Att1c * o3_Att1c + ce_Att2_1 * o3_Att2_1 + ce_Att3_1 * o3_Att3_1 + ce_Att3_2 * o3_Att3_2 + ce_Att4c * o3_Att4c + ce_Att5c * o3_Att5c + ce_Att6c * o3_Att6c  
  v4 <- ce_None * o4_None + ce_Att1c * o4_Att1c + ce_Att2_1 * o4_Att2_1 + + ce_Att3_1 * o4_Att3_1 + ce_Att3_2 * o4_Att3_2 + ce_Att4c * o4_Att4c + ce_Att5c * o4_Att5c + ce_Att6c * o4_Att6c  
...
control <- list(
  modelname = "HB_mxl_system",
  gDIST = c(1, 2, 1, 1, 1, 2, 2),
  gVarNamesNormal = c("None", "Att1c", "Att2_1", "Att3_1", "Att3_2", "Att4c", "Att5c"),
...
fn_A <- paste(getwd(),"/HB_output/HB_mxl_system_A.csv",sep = "")
fn_B <- paste(getwd(),"/HB_output/HB_mxl_system_B.csv",sep = "")
fn_Bsd <- paste(getwd(),"/HB_output/HB_mxl_system_Bsd.csv",sep = "")
fn_C <- paste(getwd(),"/HB_output/HB_mxl_system_C.csv",sep = "")
fn_Csd <- paste(getwd(),"/HB_output/HB_mxl_system_Csd.csv",sep = "")
fn_D <- paste(getwd(),"/HB_output/HB_mxl_system_D.csv",sep = "")
fn_F <- paste(getwd(),"/HB_output/HB_mxl_system_F.csv",sep = "")
fn_pvMatrix <- paste(getwd(),"/HB_output/HB_mxl_system_pvMatrix.csv",sep = "")
fn_log <- paste(getwd(),"/HB_output/HB_mxl_system.log",sep = "")
